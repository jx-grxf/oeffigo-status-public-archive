...
// stripe >= 22 throws on an empty key at import, which would crash every app
// that loads the router on a self-hosted install without billing.
export const stripe = new Stripe(env.STRIPE_SECRET_KEY || "sk_unconfigured", {
